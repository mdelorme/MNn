.. MNn documentation master file, created by
   sphinx-quickstart on Mon Apr 11 10:13:20 2016.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to MNn's documentation!
===============================
...
* Authors :
  ...
  - `Armando Rojas-Niño <armando.rojas@iems.edu.mx>`_ (Universidad Nacional Autonoma de Mexico)
  - `Justin I. Read <j.read@surrey.ac.uk>`_ (University of Surrey)
  - `Luis Aguilar <aguilar@astrosen.unam.mx>`_ (Universidad Nacional Autonoma de Mexico)
